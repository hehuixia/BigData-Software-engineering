...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function add(){
			...
			select.options[0] = new Option("一", "一");
	        select.options[1] = new Option("二", "二");
	        select.options[2] = new Option("三", "三");
	        select.options[3] = new Option("四", "四");
	        select.options[4] = new Option("五", "五");
	        select.options[5] = new Option("六", "六");
	        select.options[6] = new Option("日", "日");
	        var textnode1=document.createTextNode("星期：");
			Temo.appendChild(textnode1);
