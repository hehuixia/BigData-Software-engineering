	...
	<div class="ab_content" style=" margin-top:0px ; padding-top:20px;">
		...
		<div class="container">
			...
			<div class="row">
				...
				<c:forEach var="picture" items="${allpaper}">
					<div class="col-md-6 " style="background-color:;margin-bottom:40px;">
								...
								<ul style="list-style: none;background-color:#F5F5F5 " margin-top:10px;>
									...
									<c:forEach  var="other" items="${allother}">
									...
									<%-- <li><span style="margin-left:75px;margin-top:10px">上传时间：${picture.apply_time}</span><br></li> 
									<c:forEach  var="other" items="${allother}">
										<c:if test="${other.class_id==picture.class_id }">
											<li><span style="margin-left:75px;margin-top:10px">学生：${picture.student.name}</span><br></li> 
											<li><span style="margin-left:75px;margin-top:10px">课程：${other.course.cname}</span><br></li> 
											<li><span style="margin-left:75px;margin-top:10px">班级名称：${other.class_name}</span><br></li> 
										</c:if>
									</c:forEach>
									
									<c:if test="${picture.status==0 }">
										
										<li><span style="margin-left:75px">审核状态：未审核</span><br></li>
									</c:if>
									<c:if test="${picture.status==1 }">
										
										<li><span style="margin-left:75px">审核状态：同意</span><br></li>
									</c:if>
									<c:if test="${picture.status==2}">
										
										<li><span style="margin-left:75px">审核状态：不同意</span><br></li>
									</c:if>
									<li style="text-align:center"><img alt="" src="../${picture.img_src}" width="400px" height="300px"></li> --%>
